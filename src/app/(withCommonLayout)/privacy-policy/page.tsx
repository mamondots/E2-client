      ...
      <div className="Container py-6 lg:mt-4">
        <div className="flex flex-col gap-2 lg:gap-4">
          ...
          <div className="policy-page-text">
            Titasweb respects and protects the privacy of our customers and
            users who visit our websites. Titasweb knows that you care how
          ...
          <div className="policy-page-text ">
            ...
            the services provided by Titasweb.com you agree to the collection
            and use of your data by Titasweb.com in the manner provided in this
            Privacy Policy.
          </div>
          ...
          <div className="">
            ...
            <ul className="policy-page-text policy-page-li">
              ...
              <li>
                ...
                safety or security of any person, violations of Titasweb.com s
          ...
          <div>
            ...
            <div className="policy-page-text">
              ...
              Titasweb.com reserves the right to send you certain service
              related communication, considered to be a part of your
              Titasweb.com account without offering you the facility to opt-out.
          ...
          <div className="policy-page-text">
            ...
            you at any stage want to delete your personal data from Titasweb,
            across all platforms, you have the full right to do so. Please send
            an email to support@Titasweb.com, we will process your request
